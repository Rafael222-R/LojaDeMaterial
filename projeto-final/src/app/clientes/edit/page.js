...
export default function clientesFormPage(props) {
  ...
  function salvar(dados) {
    console.log(dados);
    axios
      .put("http://localhost:3000/clientes/" + id, dados)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    cpf: yup.string("Campo precisa ser um texto").required("Campo obrigatório"),
    telefone: yup
      .string("Campo precisa ser um texto")
      .required("Campo obrigatório"),
    email: yup
                ...
                <Row className="mb-2">
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Select
                      ...
                      isInvalid={
                        touched.status_cliente && errors.status_cliente
                      }
                    >
