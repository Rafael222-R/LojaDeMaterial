...
export default function CargosEditPage(props) {
  ...
  function salvar(dados) {
    console.log(dados);
    axios
      .put("http://localhost:3000/cargos/" + id, dados)
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
  ...
  const validationSchema = Yup.object().shape({
    nome: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    descricao: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    salario: Yup.string("Campo salario precisa ser numerico").required(
      "Campo Salario é Obrigatorio"
    ),
    habilidade: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    status_cargo: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    departamento: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    nivel_hierarquico: Yup.string("Campo nome precisa ser um texto").required(
      "Campo nome é Obrigatorio"
    ),
    data_criacao: Yup.date("Data Inválida").required(
      "Campo nome é Obrigatorio"
    ),
  });
            ...
            return (
              <Form onSubmit={handleSubmit}>
                ...
                <Row className="mb-2">
                  ...
                  <Form.Group as={Col}>
                    ...
                    <Form.Select
                      ...
                      onBlur={handleBlur}
                      isValid={
                        touched.nivel_hierarquico && !errors.nivel_hierarquico
                      }
                      isInvalid={
                        touched.nivel_hierarquico && errors.nivel_hierarquico
                      }
                ...
                <Form.Group className="text-end">
                  <Button className="me-2" href="/cargos">
                    <FaArrowLeft /> Voltar
                  </Button>
